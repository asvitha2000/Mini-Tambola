...
//				System.out.println(gameData.announcedNumber);
				...
				while(!gameData.playerChanceFlag[0] || !gameData.playerChanceFlag[1]) {
					try {
//						System.out.println("i am waiting for players to finish...");
						gameData.lock1.wait();
					} catch (InterruptedException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
		...
		{			
			...
			while(!gameData.gameCompleteFlag){
				...
				while(!gameData.noAnnouncedFlag || gameData.playerChanceFlag[id]) {
					try {
//						System.out.println("i'll wait as num not announced...");
						gameData.lock1.wait();
					} catch (InterruptedException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
...
//					System.out.println(id + " , i just checked my tickets!");					
